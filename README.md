...
- `lib/repositories/task_repository.dart` → gestion des tâches (ajout, suppression, tri par priorité et par date)
...
Réorganisation de l’architecture en sous‑répertoires (models, repositories, services)
